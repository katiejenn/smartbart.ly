...
linesAll.push(
	...
	{name: "Dublin/Pleasanton - Daly City", abbreviation: "DUBL-DALY", "number"=>"11", direction: "west", color: "#0099cc", stations: ["DUBL", "WDUB", "CAST", "BAYF", "SANL", "COLS", "FTVL", "LAKE", "WOAK", "EMBR", "MONT", "POWL", "CIVC", "16TH", "24TH", "GLEN", "BALB", "DALY"]},
	{name: "Daly City - Dublin/Pleasanton", abbreviation: "DALY-DUBL", "number"=>"12", direction: "east", color: "#0099cc", stations: ["DALY", "BALB", "GLEN", "24TH", "16TH", "CIVC", "POWL", "MONT", "EMBR", "WOAK", "LAKE", "FTVL", "COLS", "SANL", "BAYF", "CAST", "WDUB", "DUBL"]},
