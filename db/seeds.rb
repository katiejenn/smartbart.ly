...
linesAll.push(
	...
	{name: "Daly City - Fremont", abbreviation: "daly-frmt", "number"=>"6", direction: "north", color: "#339933", stations: ["DALY", "BALB", "GLEN", "24TH", "16TH", "CIVC", "POWL", "MONT", "EMBR", "WOAK", "LAKE", "FTVL", "COLS", "SANL", "BAYF", "HAYW", "SHAY", "UCTY", "FRMT"]},
	...
	{name: "Coliseum - Oakland Int'l Airport", abbreviation: "COLS-OAKL", "number"=>"19", direction: "south", color: "#d5cfa3", stations: ["COLS", "OAKL"]},
	{name: "Oakland Int'l Airport - Coliseum", abbreviation: "OAKL-COLS", "number"=>"20", direction: "north", color: "#d5cfa3", stations: ["OAKL", "COLS"]}
	)
